...
class Gig extends Item
{
  ...
  public const TABLE = 'gig';
  public const CATEGORY = 'openconsult\content\tag\category\Gig';
  public const LOCATION = 'openconsult\content\tag\location\Gig';
  public const CURRENCY = 'openconsult\content\tag\currency\Gig';
  public const FAVORITE = 'openconsult\content\tag\favorite\Gig';
  public const TOTAL = 'openconsult\content\total\Gig';
